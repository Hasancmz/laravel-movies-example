...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        ...
        @endif --}}
        <div class="flex-none mx-auto">
            <img src="{{  'https://image.tmdb.org/t/p/w300_and_h450_bestv2/fysvehTvU6bE3JgxaOTRfvQJzJ4.jpg' }}" alt="sonic" class="">  
        ...
        <div class="mx-auto mt-10 md:ml-24">
            <h2 class="text-4xl font-semibold mb-2">Will smith</h2>
            <div class="flex flex-wrap items-center text-gray-400 text-sm" >
                ...
                <span class="ml-2">Feb 20, 2010 (25 years old) in Toronto</span>

            </div>

            <p class="text-gray-300 mt-8 break-all">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates placeat et similique, at atque quia facere! Ea, dolore aspernatur optio quas eaque nam, et sed repellat explicabo corrupti quaerat unde quae iste voluptates cumque facere? Eligendi iure praesentium omnis maiores?
            </p>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-5 gap-8">
                <div class="mt-4">
                    <a href=""><img src="https://image.tmdb.org/t/p/w150_and_h225_bestv2/rwQrIAQZodZD50ML3JL7iSjnldY.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></a>
                    <a href="" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">Avengers</a>
                </div>
                <div class="mt-4">
                    <a href=""><img src="https://image.tmdb.org/t/p/w150_and_h225_bestv2/rwQrIAQZodZD50ML3JL7iSjnldY.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></a>
                    <a href="" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1"></a>
                </div>
                <div class="mt-4">
                    <a href=""><img src="https://image.tmdb.org/t/p/w150_and_h225_bestv2/rwQrIAQZodZD50ML3JL7iSjnldY.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></a>
                    <a href="" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1"></a>
...
<div class="credits border-b border-gray-800">
    <div class="container mx-auto px-4 py-16">
        ...
        <ul class="list-disc leading-loose pl-5 mt-8">
            <li>
                <strong><a href="" class="hover:underline">Babylon as</a></strong>
             </li>
        </ul>
    </div>
</div>
